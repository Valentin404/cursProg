...
const contentCurs = document.querySelectorAll('.contentCurs')
document.querySelectorAll('.contChoice').forEach((elem,ind)=>{
    elem.addEventListener('click',e=>{

        document.querySelector('.contChoice.active').classList.remove('active')
        document.querySelector('.contentCurs.active').classList.remove('active')

        elem.classList.add('active')
        contentCurs[ind].classList.add('active')
    })
})
