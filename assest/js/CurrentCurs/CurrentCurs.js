...
<div class="globPriveleg">
    ...
    <div class="globCurrentPriveleg">
        ...
        <div class="currentPriveleg reverse">
            ...
            <p>Полученные знания мы применяем в практических задачах после каждой новой темы.</p>
        </div>
        <div class="currentPriveleg">
            <div class="currentPrivelegContImg">
            ...
            <p>Предоставляем полнную поддержку до Вашего трудоустройства и можем помочь в первое время
        ...
        <div class="currentPriveleg reverse">
            ...
            <p>Мы поможем вам создать свое портфолио которое вы сможете показать своему будущему
                работодателю.
            </p>
        </div>
    </div>
